...
On larger screens the navigation bar is horizontal and centered. on smaller screens it stacks vertical in the center and has a black underline.
...
and a copywriter of the author.
...
The brewery motto.
Images of the 3 different beer styles that the brewery makes.
...
* I have used padding and margin to make sure that the content is not too close together.
